...
namespace sang.Controllers
{
    public class MonHocsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaMonHoc,TenMonHoc,SoTietLyThuyet,SoTietThucHanh")] MonHoc monHoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaMonHoc,TenMonHoc,SoTietLyThuyet,SoTietThucHanh")] MonHoc monHoc)
        {
            if (ModelState.IsValid)
            {
